...
image_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
flip_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
rotate_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
color_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
erase_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
save_icon = ttk.PhotoImage(file = 'png/carre.png').subsample(12, 12)
