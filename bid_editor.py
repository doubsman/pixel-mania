...
class ImageEditorApp(BidFile, ActionState):
    ...
    def initialize_ui(self):
        ...
        self.grid_width_label = ttk.Label(width_frame, text="00", font=('TkDefaultFont', 12, 'bold'))
        ...
        self.grid_height_label = ttk.Label(height_frame, text="00", font=('TkDefaultFont', 12, 'bold'))
